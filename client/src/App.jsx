      ...
      <footer className="bg-white/80 dark:bg-gray-900/80 py-8 backdrop-blur-sm relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-bold text-lg mb-4 text-brand-peach dark:text-brand-beige">HnaKids</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Achetez et vendez des vêtements et accessoires pour enfants de qualité à prix réduits.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-lg mb-4 text-brand-sage dark:text-brand-sage">Liens rapides</h3>
            ...
            <div>
              <h3 className="font-bold text-lg mb-4 text-brand-beige dark:text-brand-beige">Informations</h3>
              <ul className="space-y-2">
                <li>
                  <a
                    href="/faq"
            ...
            <div>
              <h3 className="font-bold text-lg mb-4 text-brand-peach dark:text-brand-peach">Contact</h3>
